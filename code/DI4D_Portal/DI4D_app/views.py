...
from .models import ApplicationSetting, News, User, Question, FormAnswer, TechTalk, Form, UserType, Partner, LearningGoal, LearninggoalCourse, HistoryStudentApplicationForm, StatusStudentRegistration
