...
urlpatterns = [
    ...
    path('files/open/<str:item_token>/', views.files_wopi_open, name='files_wopi_open'),
    path('files/action/<str:action>/', views.files_action, name='files_action'),
    path('wopi/files/<int:file_id>', views.wopi_check_file_info, name='wopi_check_file_info'),
    path('wopi/files/<int:file_id>/contents', views.wopi_contents, name='wopi_contents'),
    ...
    path('news/content-upload/', views.news_content_upload, name='news_content_upload'),
    path('news/content-image/<path:storagePath>/', views.news_content_image, name='news_content_image'),
